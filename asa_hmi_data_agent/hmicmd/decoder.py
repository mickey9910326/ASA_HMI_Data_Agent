...
#     def put(self, ch):
#         if self._sm.state == InnerState.STATE_HEADER:
#             if ch == _CONST_HEADER:
#                 self._sm.state = InnerState.STATE_CMDTYPE
#                 self._state = PROCESSING
#             else:
#                 self._state = NOTPROCESSING

#         elif self._sm.state == InnerState.STATE_CMDTYPE:
#             if ch == _CONST_DOT:
#                 self._sm.state = InnerState.STATE_FS
#                 self._state = PROCESSING
#             else:
#                 self._state = NOTPROCESSING
#             if self._sm.count == 0:
...
#         elif self._sm.state == InnerState.STATE_FS:
#             self._sm.chksum += ch
