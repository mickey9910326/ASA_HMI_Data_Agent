...
class Ui_MainWidgetHMI(object):
    ...
    def retranslateUi(self, MainWidgetHMI):
        ...
        self.buttonTerminalSend.setText(_translate("MainWidgetHMI", "Send"))
        self.buttonTerminalClear.setText(_translate("MainWidgetHMI", "清除對話框"))
        self.buttonTerminalSave.setText(_translate("MainWidgetHMI", "儲存對話框"))
